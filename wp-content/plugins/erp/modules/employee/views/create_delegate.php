...
<div class="postbox">
       ...
       <div class="cols">
           <label>From</label>
           <input type="text" class="" name="txtDelegatedatefrom" id="from" onClick="this.readOnly=true" parsley-required="true"/>
       </div>
       <div class="cols last">
           <label>To</label>
           <input type="text" class="" name="txtDelegatedateto" id="to" onClick="this.readOnly=true" parsley-required="true"/>
       </div>
       </div>
       <div class="row">
