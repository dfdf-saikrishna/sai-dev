                    ...
                    <div class="badge-wrap badge-aqua">
                        ...
                        <table class="wp-list-table widefat striped admins">
                            ...
                            <tr>
                                ...
                                <td width="20%"><a href="/wp-admin/admin.php?page=View-Emp-Requests&selReqstatus=2"><span class="oval-3"><?php echo $count_approved ?></span></a></td>
                            </tr>
                            <tr>
                                <td width="90%">Rejected Requests</td>
                                <td width="10%"><a href="/wp-admin/admin.php?page=View-Emp-Requests&selReqstatus=3"><span class="oval-4"><?php echo $count_rejected ?></span></a></td>
                            </tr>
                            <tr>
                                <td width="90%">Total Requests</td>
                                <td width="10%"><a href="/wp-admin/admin.php?page=View-Emp-Requests"><span class="oval-2"><?php echo $count_total ?></span></a></td>
                            </tr>
                        </table>
