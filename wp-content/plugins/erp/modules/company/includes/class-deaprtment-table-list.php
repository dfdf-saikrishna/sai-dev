...
class Departments_List_Table extends \WP_List_Table {
    ...
    function column_name($item) {
        ...
        return sprintf('%s %s', '<a href="' . erp_company_url_single_departments($item['DEP_Id']) . '"><strong>' . $item['DEP_Name'] . '</strong></a>', $this->row_actions($actions)
    ...
    function get_columns() {
        $columns = array(
            ...
            'total' => __('Employees', 'department_table_list'),
