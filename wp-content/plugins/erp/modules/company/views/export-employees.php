                   ...
                   <?php
                            ...
                            if (preg_match('/\b' . $rowData[0][0] . '\b/',$empnotadded)){
                                ...
                                if($rowData[0][0] == ""){
                                    ...
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("10", $row, 'Email Id Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Email Id Missing'>";
                                }
                                else if($rowData[0][4] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("10", $row, 'Reporting Manager Code Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Reporting Manager Code Missing'>";
                                }
                                else if($rowData[0][8] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("10", $row, 'Functional Reporting Manager Code Missing');
                                    echo "<tr bgcolor='#ff8c8c' data-toggle='tooltip' title='Functional Reporting Manager Code Missing'>";
                                }
                                else if($rowData[0][9] == ""){
                                    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow("10", $row, 'Employee Grade Missing');
