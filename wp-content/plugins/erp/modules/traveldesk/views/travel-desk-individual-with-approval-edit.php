              ...
              <div style="margin-top:60px;">
                ...
                <table class="wp-list-table widefat striped admins" border="0" id="traveldesk_request">
                      ...
                      <tbody>
                          ...
                          ?>
                        <tr>
                          <td data-title="Date" class=""><input name="txtDate[]" id="txtDate<?php echo $rows; ?>" class="pretraveldate" placeholder="dd/mm/yyyy" autocomplete="off" value="<?php if($rowrequest->RD_Dateoftravel=="0000-00-00") echo ""; else echo date('d/m/Y',strtotime($rowrequest->RD_Dateoftravel)); ?>" <?php echo $disabled ? 'readonly="readonly"':'';?>/>
