...
class Ajax_Handler {
    ...
    public function __construct() {
        ...
        $this->action( 'wp_ajax_traveldeskdropdown', 'traveldropdown_create' );
        //$this->action( 'wp_ajax_travelcompany_get', 'travelcompany_get' );
        //$this->action( 'wp_ajax_travelcompany_delete', 'travelcompany_remove' );
...
//        }
     ...
     public function travelcompany_create() {
         //$this->verify_nonce( 'wp-erp-hr-employee-nonce' );
        //$data = "sai";
        //$this->send_success( $data );
		//$this->verify_nonce( 'wp-erp-hr-employee-nonce' );
...
//        }
        ...
        $employee_id  = travelcompany_insert( $posted );
...
//            }
        //}
        $data = $posted;
        $this->send_success( $employee_id );
    }
    
    public function travelcompany_get() {
        global $wpdb;
 //       $this->verify_nonce( 'wp-erp-hr-nonce' );
...
//        $this->send_success( $employee->to_array() );
        $response = $wpdb->get_row("SELECT * FROM travel_desk WHERE COM_Id = $id");
        $this->send_success($response);
    }
    
    public function traveldropdown_create() {
        global $wpdb;
 //       $this->verify_nonce( 'wp-erp-hr-nonce' );
...
//       $employee = new Employee( $user );
//        $this->send_success( $employee->to_array() );
        $companylist = $wpdb->get_row( "SELECT * FROM  employees emp, company com, department dep, designation des, employee_grades eg WHERE emp.EMP_Id=$val AND com.COM_Id=$compid AND emp.COM_Id=com.COM_Id AND emp.DEP_Id=dep.DEP_Id AND emp.DES_Id=des.DES_Id AND emp.EG_Id=eg.EG_Id");
        //$response = $wpdb->get_row("SELECT * FROM travel_desk WHERE COM_Id = $id");
        $this->send_success($companylist);
    }
...
//        $employee = new Employee( $user );
    ...
    public function employee_remove() {
     ...
     public function travelcompany_remove() {
        global $wpdb;
     ...
     * @return void
     */
    public function travelcompany_restore() {
        $this->verify_nonce( 'wp-erp-hr-nonce' );
